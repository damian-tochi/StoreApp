...
import com.example.storeapp.databinding.ActivityOnboardBinding
...
class OnboardActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        binding.loginButton.setOnClickListener {
            SessionState.instance.saveValuesToPreferences(this, AppConstants.Companion.PREFERENCES.USER_EMAIL.toString(), "visitor@shopper.com")
            SessionState.instance.saveValuesToPreferences(this, AppConstants.Companion.PREFERENCES.USER_FULL_NAME.toString(), "Visitor")
